...
def get_arguments():
    ...
    #workspace:
    parser.add_argument('--not_cuda', action='store_true', help='disables cuda/mps acceleration', default=0)
    ...
    parser.add_argument('--input_name', help='input image name')  # removed required=True
    ...
    parser.add_argument('--scale_factor', type=float, default=0.75,
                      help='Scale factor for image scaling')
    parser.add_argument('--noise_amp',type=float,help='addative noise cont weight',default=0.1)
    parser.add_argument('--min_size',type=int,help='image minimal size at the coarser scale',default=25)
    parser.add_argument('--max_size', type=int,help='image minimal size at the coarser scale', default=512)
